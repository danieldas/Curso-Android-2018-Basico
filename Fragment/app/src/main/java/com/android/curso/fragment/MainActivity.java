package com.android.curso.fragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentTransaction.replace(R.id.llContenedor, primerFragment);
            fragmentTransaction.commit();
        } else if (id == R.id.nav_gallery) {
            SegundoFragment segundoFragment=new SegundoFragment();
            FragmentTransaction fragmentTransaction=getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.llContenedor, segundoFragment);
            fragmentTransaction.commit();
        } else if (id == R.id.nav_slideshow) {
            TercerFragment tercerFragment=new TercerFragment();
            FragmentTransaction fragmentTransaction=getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.llContenedor, tercerFragment);
            fragmentTransaction.commit();
